...
//#define ASSISTED_TRAMMING
   ...
   */
 4#define TRAMMING_SCREW_THREAD M4_CW
...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  21.52        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  26.06        // (Hz) The default dominant resonant frequency on the Y axis.
