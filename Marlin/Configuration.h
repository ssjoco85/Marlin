...
//#define CUSTOM_MACHINE_NAME "Ender-3 Pro-SSJ"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  44.0364
  #define DEFAULT_BED_KI   8.60090
  #define DEFAULT_BED_KD 150.311
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 888.1 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 600, 600, 120, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -8, -3.38 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
