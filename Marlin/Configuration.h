...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  35.8703
    #define DEFAULT_KI   7.00590
    #define DEFAULT_KD 45.9140
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  39.9368
  #define DEFAULT_BED_KI   4.30350
  #define DEFAULT_BED_KD 247.075
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.25, -12.8, -1.1 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define PROBE_OFFSET_Z_MIN -2.5
#define PROBE_OFFSET_Z_MAX 2.5
