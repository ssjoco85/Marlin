...
//#define CUSTOM_MACHINE_NAME "Ender-3 Pro-SSJv3"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  44.04
  #define DEFAULT_BED_KI   8.60
  #define DEFAULT_BED_KD  150.31
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 2500, 300, 2000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -4, -0.70} // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
